function chart_partner(slug) {
    var url = `/transactions/${slug}/get_chart_partner`;
    $.ajax({
          url: url,
    ...
    var element = document.getElementById("kt_charts_widget_1_chart_partner");
 ...
 $(document).ready(function() {
    chart_partner(
        $('#kt_charts_widget_1_chart_partner').data("slug")
    );
});