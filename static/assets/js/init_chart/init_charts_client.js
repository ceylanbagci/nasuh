function chart_client(slug) {
    console.log(slug);
    var url = `/transactions/${slug}/get_chart_client`;
    console.log(url);
    $.ajax({
          url: url,
    ...
    var element = document.getElementById("kt_charts_widget_1_chart_client");
 ...
 $(document).ready(function() {
    chart_client(
        $('#kt_charts_widget_1_chart_client').data("slug")
    );
});