function chart_other(slug) {
    console.log(slug);
    var url = `/transactions/${slug}/get_chart_other`;
    console.log(url);
    $.ajax({
          url: url,
    ...
    var element = document.getElementById("kt_charts_widget_1_chart_other");
 ...
 $(document).ready(function() {
    chart_other(
        $('#kt_charts_widget_1_chart_other').data("slug")
    );
});