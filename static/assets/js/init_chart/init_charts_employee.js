function chart_employee(slug) {
    var url = `/transactions/${slug}/get_chart_employee`;
    $.ajax({
          url: url,
    ...
    var element = document.getElementById("kt_charts_widget_1_chart_employee");
 ...
 $(document).ready(function() {
    chart_employee(
        $('#kt_charts_widget_1_chart_employee').data("slug")
    );
