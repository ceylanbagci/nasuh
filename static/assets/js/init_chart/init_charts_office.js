function chart_office(slug) {
    console.log(slug);
    var url = `/transactions/${slug}/get_chart_office`;
    console.log(url);
    $.ajax({
          url: url,
    ...
    var element = document.getElementById("kt_charts_widget_1_chart_office");
 ...
 $(document).ready(function() {
    chart_office(
        $('#kt_charts_widget_1_chart_office').data("slug")
    );
});