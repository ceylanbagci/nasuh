function chart_case(slug) {
    var url = `/transactions/${slug}/get_chart_case`;
    $.ajax({
          url: url,
    ...
    var element = document.getElementById("kt_charts_widget_1_chart_case");
 ...
 $(document).ready(function() {
    chart_case(
        $('#kt_charts_widget_1_chart_case').data("slug")
    );
