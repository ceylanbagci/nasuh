function chart_tax(slug) {
    console.log(slug);
    var url = `/transactions/${slug}/get_chart_tax`;
    console.log(url);
    $.ajax({
          url: url,
    ...
    var element = document.getElementById("kt_charts_widget_1_chart_tax");
 ...
 $(document).ready(function() {
    chart_tax(
        $('#kt_charts_widget_1_chart_tax').data("slug")
    );
});